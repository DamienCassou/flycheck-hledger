...
This package is similar to [[https://github.com/DamienCassou/flymake-hledger][flymake-hledger]], except that the latter
uses [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Flymake.html][Flymake]], which is built into Emacs, whereas Flycheck is a separate
package you have to install.
